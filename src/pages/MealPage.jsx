...
const MealPage = () => {
    ...
    const getMealType = async () =>{
        const api = await fetch(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${process.env.REACT_APP_API_KEY}&type=${params.meal}&number=9`);
  ...
  return (
    <Container>
        <h2>Choose best dishes to eat!</h2>
        <Cards>
